...
metadata validators = [
    {
        ...
        configuration: {
            bindToTrait: aws.proto.routeoptimizationaccelerator#handler
            selector: """
                :not([@trait|aws.proto.routeoptimizationaccelerator#handler: @{language} = typescript, java, python])
            """
            messageTemplate: """
                @{trait|aws.proto.routeoptimizationaccelerator#handler|language} is not supported by type-safe-api.
