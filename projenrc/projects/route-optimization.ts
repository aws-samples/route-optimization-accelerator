  ...
  constructor(props: RouteOptimizationProjectContainerProps) {
    ...
    const optimizationEngine = new JavaProject({
      ...
      deps: [
        ...
        "ai.timefold.solver/timefold-solver-core@1.8.0",
        "ai.timefold.solver/timefold-solver-core-impl@1.8.0",
        "ai.timefold.solver/timefold-solver-constraint-streams@1.8.0",
        // "ai.timefold.solver/timefold-solver-constraint-streams-common@1.8.0",
        // "ai.timefold.solver/timefold-solver-constraint-streams-bavet@1.8.0",
        "ai.timefold.solver/timefold-solver-jackson@1.8.0",
      ],
