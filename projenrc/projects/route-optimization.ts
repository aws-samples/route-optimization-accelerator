  ...
  constructor(props: RouteOptimizationProjectContainerProps) {
    ...
    const optimizationEngine = new JavaProject({
      ...
      deps: [
        ...
        "software.amazon.awssdk/location@2.29.40",
        "software.amazon.awssdk/secretsmanager@2.29.40",
        "software.amazon.awssdk/ssm@2.29.40",
        "software.amazon.awssdk/eventbridge@2.29.40",
        ...
        "ai.timefold.solver/timefold-solver-core@1.19.0",
        ...
        "ai.timefold.solver/timefold-solver-jackson@1.19.0",
      ],
